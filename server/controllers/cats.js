...
export const addCat = async (req,res) => {
    ...
    try {
        const newCat = await Cats.create({ catName, catClicks, catImageURL, catAge, catNicks })
...
export const activateCat = async (req,res) => {
    ...
    try {        
        ...
        const activatedCat = await Cats.findByIdAndUpdate(_id, { $set: {'catActive': true}}, {new: true})
...
export const incrementClicks = async (req,res) => {
    ...
    try {
        const clickedCat = await Cats.findByIdAndUpdate(_id , { $set : {'catClicks': catClicks, 'catAge': catAge}}, {new: true})
...
export const updateCat = async (req,res) => {
    ...
    try {
        const updatedCat = await Cats.findByIdAndUpdate(_id , { $set : {'catImageURL': catImageURL,'catClicks': catClicks, 'catAge': catAge, 'catNicks': catNicks}}, {new: true})
